...
<body>
  ...
  <main>
    ...
    <ul class="list" id="list">
      ...
      <li class="list__item">
        <a href="{{size + "/10"}}">
          <img class="item__img" src="https://avatars.mds.yandex.net/i?id=8c2025c4c625de402b1d9f12cbabdd9a_l-10596448-images-thumbs&n=13">
          <span>Наша экологичная сборка</span></a>
      </li>
    </ul>
    {% endblock %}
  </main>
